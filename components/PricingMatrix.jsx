...
const GROUPS = [
  {
    ...
    rows: [
      ...
      { t: 'Leave requests with balance and cover', v: [true, true, true, true] },
      { t: 'Leave policy engine', v: ['Basic', 'Accrual, carry-over, holidays', 'Accrual, carry-over, holidays', 'Custom rules'] },
      { t: 'Sites on one record', v: ['1', 'Unlimited', 'Unlimited', 'Unlimited'] },
    ],
  },
  {
    name: 'Productivity & performance',
    rows: [
      { t: 'Activity insights, no screenshots', v: [true, true, true, true] },
      { t: 'Performance grades', v: [false, true, true, true] },
      { t: 'Work logs against the grade', v: [false, true, true, true] },
      { t: 'Grade formula you define', v: [false, false, true, true] },
    ],
  },
  {
    name: 'People & operations',
    rows: [
      { t: 'HR records and directory', v: [true, true, true, true] },
      { t: 'Payroll runs with statutory deductions', v: [false, true, true, true] },
      { t: 'Staff lifecycle, onboarding to exit', v: [false, true, true, true] },
      { t: 'Policy sign-off tracking', v: [false, true, true, true] },
      { t: 'Cases and multi-step approvals', v: [false, true, true, true] },
      { t: 'Custom forms', v: [false, true, true, true] },
    ],
  },
  {
  ...
  },
  {
    name: 'Support',
    rows: [
      { t: 'Email and in-app chat', v: [true, true, true, true] },
