...
//
// Drawn to brief and geometry-checked, then converted verbatim — the
// coordinates are untouched. Only two things were added: the whole drawing is
// wrapped so it arrives on the hero's reveal curve, and the long dashed path
// carries .illo-march so it loops like the reference's road does.
  ...
  return (
    <div className="hero-art" aria-hidden="true">
      <svg viewBox="0 0 520 340" fill="none" strokeLinecap="butt" strokeLinejoin="miter">
        ...
        <polyline points="199.5,97 203,109 200.5,120" stroke="#17171C" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"/>
        <circle cx="189.4" cy="80" r="9.5" fill="#FFFFFF" stroke="#17171C" strokeWidth="2"/>
        ...
        <polygon points="320.4,142.4 345.3,156.8 345.3,154.4 320.4,140" fill="#4024C0"/>
        <line x1="325.6" y1="85.4" x2="325.6" y2="104.6" stroke="#4024C0" strokeWidth="2" strokeDasharray="4 4"/>
        <polygon points="296.5,68.6 354.6,102.2 354.6,68.6 296.5,35" fill="#FFFFFF" stroke="#17171C" strokeWidth="2"/>
        <polyline points="306.8,60.2 314.1,72.8 329.7,63.8" stroke="#4024C0" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <circle cx="268.4" cy="140" r="9.5" fill="#FFFFFF" stroke="#17171C" strokeWidth="2"/>
